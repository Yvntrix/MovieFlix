...
$query = "INSERT INTO email ( `name`, `email`, `content`,`sent`)VALUES('$name ','$email','$content','$date')";
...
$email->setSubject('Thank you for your concern, ' . $_POST['name']);
  ...
  * {
  ...
  <table style="font-family:georgia,palatino;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="color: #7f87a7; line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;">&copy; MovieFlix 2021 All Rights Reserved</p>
    </div>
